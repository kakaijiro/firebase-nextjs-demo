  ...
  return (
    <main className="min-h-screen -mt-24 relative p-24 flex items-center justify-center">
      ...
      <div className="flex flex-col gap-10 text-white relative z-10">
        <h1 className="uppercase tracking-widest fotn-semibold text-5xl max-w-screen-md text-center">
          Find your new home with Firebase Home
        </h1>
        <Button asChild className="mx-auto py-8 !px-8 text-lg gap-5">
